...
public class OrderQueryRepository {
    ...
    private List<OrderQueryDto> findOrders() {
        List<OrderQueryDto> result = em.createQuery("select new jpabook.jpashop.repository.order.query.OrderQueryDto(o.id, m.name,o.orderData, o.status, o.address)" +
                " from Order o " +
                " join o.member m" +
                " join o.member m" +
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        List<OrderItemQueryDto> orderItems = em.createQuery("select new jpabook.jpashop.repository.order.query.OrderItemQueryDto" +
                        ...
                        " from OrderItem oi" +
                        " join oi.item i" +
                        "where io.order.id in :orderIds", OrderItemQueryDto.class)
